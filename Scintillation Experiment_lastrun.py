...
practice_loop = data.TrialHandler(nReps=1, method='random', 
    ...
    trialList=data.importConditions('experimental_stim_list.xlsx', selection='24:34'),
...
for thisPractice_loop in practice_loop:
    ...
    while continueRoutine:
        ...
        if image_key_resp.status == STARTED and not waitOnFlip:
            theseKeys = image_key_resp.getKeys(keyList=['space', '1', '0'], waitRelease=False)
...
# set up handler to look after randomisation of conditions etc
experimental_loop = data.TrialHandler(nReps=2, method='random', 
    extraInfo=expInfo, originPath=-1,
...
# completed 2 repeats of 'experimental_loop'
